    ...
    <div className="relative overflow-hidden bg-[#F8FAFC]">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-4">
              ...
              <a href="https://flowcv.com/resume/64mpwf26n6m4" className="px-7 py-3 rounded-xl border border-slate-300 hover:bg-slate-100 transition">
                Download Resume
              </a>
            </div>
      ...
      <section id="about" className="py- px-6 bg-[#F8FAFC]">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <motion.a
            href="https://flowcv.com/resume/64mpwf26n6m4"
            target="_blank"
